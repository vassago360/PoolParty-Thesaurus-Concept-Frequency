...
public class conceptFrequency_v4 extends JFrame {
	...
	private JLabel lblTotalNumExtractedConceptsVal;
	private JLabel lblConceptReturnRatioVal;
	private final Action action_1 = new SwingAction_1();
 	...
 	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					conceptFrequency_v4 frame = new conceptFrequency_v4();
	...
	public conceptFrequency_v4() {
		setTitle("Pool Party Concept Frequency");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 375, 524);
		...
		findConceptsDocFreqButton.setBounds(10, 448, 339, 23);
		...
		lblTotalNumExtractedConcepts = new JLabel("Total number of extracted concepts:");
		lblTotalNumExtractedConcepts.setHorizontalAlignment(SwingConstants.LEFT);
		lblTotalNumExtractedConcepts.setBounds(10, 398, 216, 14);
		contentPane.add(lblTotalNumExtractedConcepts);
		
		
		JButton btnClear = new JButton("Clear");
		btnClear.setAction(action_1);
		btnClear.setBounds(277, 394, 72, 23);
		contentPane.add(btnClear);
		
		JLabel lblConceptReturnRatio = new JLabel("Concept Return Ratio:");
		lblConceptReturnRatio.setHorizontalAlignment(SwingConstants.LEFT);
		lblConceptReturnRatio.setBounds(10, 423, 197, 14);
		contentPane.add(lblConceptReturnRatio);
		
		lblTotalNumExtractedConceptsVal = new JLabel("0");
		lblTotalNumExtractedConceptsVal.setHorizontalAlignment(SwingConstants.RIGHT);
		lblTotalNumExtractedConceptsVal.setBounds(236, 398, 31, 14);
		contentPane.add(lblTotalNumExtractedConceptsVal);
		
		lblConceptReturnRatioVal = new JLabel("0");
		lblConceptReturnRatioVal.setHorizontalAlignment(SwingConstants.RIGHT);
		lblConceptReturnRatioVal.setBounds(217, 423, 50, 14);
		contentPane.add(lblConceptReturnRatioVal);
	...
	public static String asDecimel(long a, long b) {
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			lblTotalNumExtractedConceptsVal.setText(ppxFoundConcepts.size() + "");
			//update lblConceptReturnRatioVal
			lblConceptReturnRatioVal.setText(asDecimel(ppxFoundConcepts.size(), sp.terms.size()+ppxFoundConcepts.size()) + "");
	...
	private class SwingAction_2 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			int returnVal = fc.showOpenDialog(conceptFrequency_v4.this);
